...
# region Message
class Message:
    def __init__(self, client, chatId: str, id, time, text="", type=None, sender=None, _f=0, **kwargs):
        """
        ...
        self.user: User | None = client.get_user(id=sender, _f=1) if sender else None
